...
import org.humanResources.security.entity.AccountRoleAssociation;
...
public class JanuxUserDetails extends AccountImpl implements UserDetails
{
	 ...
	 */
	public JanuxUserDetails(AccountImpl anAccount)
	{
		try
		{ 
	...
	public Collection<GrantedAuthority> getAuthorities() 
	{
		...
		for(AccountRoleAssociation role : getRoles()){
			if (role != null) {
				SimpleGrantedAuthority grantedAuthorityImpl = new SimpleGrantedAuthority(role.getRole().getName());
